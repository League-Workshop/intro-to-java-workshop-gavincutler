...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		int pdamage = 0;
		int 	ddamage = 0;
		int rn3 = new Random().nextInt(36);
		while(playerhealth>0 && dragonhealth>0) { 
			String attack = JOptionPane.showInputDialog("attack drogon with yell or kick");
			if(attack.equals("yell")) {
				Random R = new Random();
				int rn = R.nextInt(26); 
				dragonhealth=dragonhealth-rn;
			}
			if(attack.equals("kick")) {
				Random R = new Random();
				int rn2 = R.nextInt(36);
				playerhealth=dragonhealth-rn2;
			}
			if(playerhealth <= 0) {
				JOptionPane.showMessageDialog(null, "you lost");
			}
			if(dragonhealth <= 0) {
				JOptionPane.showMessageDialog(null,"the dragon is dead and you took his gold");
